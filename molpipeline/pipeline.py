...
import joblib
import numpy as np
from sklearn.base import _fit_context, clone  # pylint: disable=protected-access
...
_AggregatedPipelineStep = Union[
    tuple[int, str, Union[AnyTransformer, AnyPredictor]],
    tuple[list[int], list[str], _MolPipeline],
]
