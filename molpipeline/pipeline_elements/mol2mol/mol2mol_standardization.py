...
class RemoveChargePipelineElement(_MolToMolPipelineElement):
    ...
    def __init__(self, name: str = "RemoveChargePipe", n_jobs: int = 1) -> None:
...
class MetalDisconnectorPipelineElement(_MolToMolPipelineElement):
    ...
    def __init__(self, name: str = "MetalDisconnectorPipe", n_jobs: int = 1) -> None:
...
class SaltRemoverPipelineElement(_MolToMolPipelineElement):
    ...
    def __init__(
        self, name: str = "SaltRemoverPipelineElement", n_jobs: int = 1
    ) -> None:
